    ...
    return(
        <div className='grid grid-cols-1 md:grid-cols-2 items-center justify-center container mx-auto'>
            <div className='flex flex-col gap-2 md:gap-5 justify-center'>
                ...
                <h1 className="text-2xl md:text-4xl text-center md:text-left font-bold bg-clip-text text-transparent" style={{backgroundImage:'var(--brand-gradient)'}}>Development Stack</h1>
                ...
                <div className='flex gap-2 justify-evenly md:justify-start mt-3'>
                    <button className="btn btn-active btn-secondary text-lg" style={{backgroundImage:'var(--brand-gradient)'}}>Explore Technologies</button>
